...
derived algebraic geometry. We mainly use the non-derived version in the paper.

\todo[inline]{Steve to address second paragraph of point 1 in Referee Report.}
...
\todo[inline]{Steve to assess the claim about root stacks.}
...
\todo[inline]{Steve to assess the completeness of this particular point thoroughly.}
...
\todo[inline]{Steve to double check these remarks.}
\end{enumerate}
