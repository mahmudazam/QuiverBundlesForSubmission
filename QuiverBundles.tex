...
investigations.
%\textit{Porta-Sala:}
Moduli stacks of quiver bundles have been constructed in great generality in
\cite[Proposition 7.1 and Corollary 7.2]{HP25} in the context of derived stacks
and derived analytic stacks. It was pointed out to us by the authors of that paper
after submitting the present work for review.
Nevertheless, in this paper, we provide an alternate, perhaps simpler, construction
...
see remarks \ref{rmk:Porta-Sala-alg-1} and \ref{rmk:Porta-Sala-alg-Higgs}.
