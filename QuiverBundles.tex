...
under suitable hypotheses on the base stack --- see \cref{thm:algebraicity}.
\end{rmk}
...
the moduli stack of vector bundles in the derived setting, as defined in, for example
\cite[Definition 10.7(iii)]{AK22}.
\end{rmk}
...
paper in the context of analytic stacks. Since the above assumptions rely only on categorical
properties of stacks, we expect them to hold for the analytic stacks
of \cite{CS19} and \cite{BKK24} as well.
\end{rmk}
